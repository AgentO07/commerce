...
urlpatterns = [
    ...
    path("closed_auctions/<str:list>", views.closed_listing, name="closed_auctions"),
    path("comment/<str:list>", views.comment, name="list"),
    path("bid/<str:list>", views.bid, name="bid"),
